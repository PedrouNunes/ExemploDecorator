Exemplo de Decorator em Java Este é um exemplo simples de um padrão de design Decorator em Java. O exemplo é baseado em uma pizzaria, onde podemos adicionar coberturas extras à pizza básica.
